...
guarded migration 017 preflighted zero partial identities and atomically strengthened the constraint with
explicit non-null predicates; this repaired the database boundary without changing this decision or
rewriting evidence.
