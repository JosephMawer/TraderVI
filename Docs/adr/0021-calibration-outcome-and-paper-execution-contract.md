...
- **Refined by:** ADR-0023 for the primary swing-policy direction, ADR-0024 for coverage/cohort reporting, and ADR-0025 for the initial three-session tradeable measure
