...
public partial class DelphiLiveAdvancedView : UserControl
{
    private DelphiLiveViewModel viewModel => (DelphiLiveViewModel)DataContext;

    public DelphiLiveAdvancedView()
    {
        InitializeComponent();
