...
namespace DailyPrice
{
    class Program
    {
        ...
        private static void GetDailyPercentGainers()
        {
        ...
        /// <param name="e"></param>
        private static void crawler_dailyPercentGainers(object sender, PageCrawlCompletedArgs e)
        {
            var quoteDetails = e.CrawledPage.HtmlDocument.DocumentNode.Descendants("table")
            ...
            //    }
            //}
            List<List<string>> table = e.CrawledPage.HtmlDocument.DocumentNode.SelectNodes("/html/body/div[2]/div[3]/div/div[5]/table[2]/tbody/tr[2]/td/table/tbody/tr/td/table/tbody")
            .Descendants("tr")
            //.Skip(1)
